        ...
        <Card className={classes.card}>
          ...
          <CardContent>
            ...
            <Typography className={this.props.pos}>
              {this.props.post.postLikes.length} likes {' '}
              <a onClick={this._handleExpandClick}>{this.props.post.postComments.length} comments</a>
            </Typography>
          </CardContent>
